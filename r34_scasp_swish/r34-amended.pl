...
according_to(r34-1,must_not(Actor, accept, Appointment)) :-
...
according_to(r34-1-a,described_in_s1(Business)) :-
...
according_to(r34-1-c,described_in_s1(X)) :- unfair(X).
...
according_to(r34-1-d,described_in_s1(X)) :- involves_sharing_fees(X,Fees,Recipient), as_compensation_for(Fees,Work), performed_by(Work,Lawyer), legal_work(Work), unauthorized(Recipient).
according_to(r34-1-d,described_in_s1(X)) :- involves_paying_commission(X,Fees,Recipient), as_compensation_for(Fees,Work), performed_by(Work,Lawyer), legal_work(Work), unauthorized(Recipient).


% (e)	any business set out in the First Schedule;

according_to(r34-1-e,described_in_s1(X)) :- described_in_first_schedule(X).
...
according_to(r34-1-f,described_in_s1(X)) :- prohibited_business(X).
...
%% the section is left as r34-1-b solely so that we do not need to rewrite the tests in order
%% for them to work.

according_to(r34-1-b,must_not(Actor, accept, Appointment)) :-
    legal_practitioner(Actor),
...
according_to(r34-2-a,may(LP,accept,EA)) :-
...
opposes(r34-1-b,must_not(LP,accept,EA),r34-2-a,may(LP,accept,EA)).
opposes(r34-1,must_not(LP,accept,EA),r34-2-a,may(LP,accept,EA)).

overrides(r34-1-b,must_not(LP,accept,EA),r34-2-a,may(LP,accept,EA)).
overrides(r34-1,must_not(LP,accept,EA),r34-2-a,may(LP,accept,EA)).
...
according_to(r34-2-b,may(LP,accept,EA)) :-
    legal_practitioner(LP),
    member_of(LP,Main_Practice),
    law_practice_in_singapore(Main_Practice),
    executive_appointment_in_a_law_practice(EA,Other_Practice),
...
opposes(r34-1,must_not(LP,accept,EA),r34-2-b,may(LP,accept,EA)).
opposes(r34-1-b,must_not(LP,accept,EA),r34-2-b,may(LP,accept,EA)).

overrides(r34-1,must_not(LP,accept,EA),r34-2-b,may(LP,accept,EA)).
overrides(r34-1-b,must_not(LP,accept,EA),r34-2-b,may(LP,accept,EA)).
...
according_to(r34-3,may(LP,accept,EA)) :-
    legal_practitioner(LP),
    executive_appointment_in_a_business_entity(EA,BE),
    provides(BE,LRS),
    law_related_service(LRS).

opposes(r34-1,must_not(LP,accept,EA),r34-3,may(LP,accept,EA)).
opposes(r34-1-b,must_not(LP,accept,EA),r34-3,may(LP,accept,EA)).

overrides(r34-1,must_not(LP,accept,EA),r34-3,may(LP,accept,EA)).
overrides(r34-1-b,must_not(LP,accept,EA),r34-3,may(LP,accept,EA)).
...
according_to(r34-4,may(LP,accept,EA)) :-
    legal_practitioner(LP),
...
opposes(r34-1,must_not(LP,accept,EA),r34-4,may(LP,accept,EA)).
opposes(r34-1-b,must_not(LP,accept,EA),r34-4,may(LP,accept,EA)).

overrides(r34-1,must_not(LP,accept,EA),r34-4,may(LP,accept,EA)).
overrides(r34-1-b,must_not(LP,accept,EA),r34-4,may(LP,accept,EA)).
...
according_to(r34-5,may(LP,accept,EA)) :-
    legal_practitioner(LP),
    locum_solicitor(LP),
    executive_appointment_in_a_business_entity(EA,BE),
    not provides_legal_or_law_related_services(BE),
...
opposes(r34-1,must_not(LP,accept,EA),r34-5,may(LP,accept,EA)).
opposes(r34-5,may(LP,accept,EA),r34-1-b,must_not(LP,accept,EA)).

overrides(r34-1,must_not(LP,accept,EA),r34-5,may(LP,accept,EA)).
overrides(r34-5,may(LP,accept,EA),r34-1-b,must_not(LP,accept,EA)).
...
according_to(r34-6-a,must_not(LP,accept,EA)) :-
    legal_practitioner(LP),
    executive_appointment_in_a_law_practice(EA,Other_Practice),
...
opposes(r34-2-a,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
opposes(r34-2-b,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
opposes(r34-3,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
opposes(r34-4,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
opposes(r34-5,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).

overrides(r34-2-a,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
overrides(r34-2-b,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
overrides(r34-3,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
overrides(r34-4,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).
overrides(r34-5,may(LP,accept,EA),r34-6-a,must_not(LP,accept,EA)).

% (b)	a legal practitioner must not accept any executive appointment in a business entity.

according_to(r34-6-b,must_not(LP,accept,EA)) :-
    legal_practitioner(LP),
    executive_appointment_in_a_business_entity(EA,BE).

opposes(r34-2-a,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
opposes(r34-2-b,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
opposes(r34-3,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
opposes(r34-4,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
opposes(r34-5,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).


overrides(r34-2-a,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
overrides(r34-2-b,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
overrides(r34-3,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
overrides(r34-4,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
overrides(r34-5,may(LP,accept,EA),r34-6-b,must_not(LP,accept,EA)).
...
according_to(r34-7,may(LP,accept,P)) :-
    legal_practitioner(LP),
    position(P),
    institution(I),
    in(P,I),
...
%?- according_to(r34-7,may(A,accept,B)).                    
% Working, 1 model
...
%?- according_to(r34-1-f,described_in_s1(X)).        
% Working, 1 model.

%?- according_to(r34-1-e,described_in_s1(X)).       
% Working, 1 model.

%?- according_to(r34-1-d,described_in_s1(X)).       
% Working, 2 models.

%?- according_to(r34-1-c,described_in_s1(X)).       
% Working, 1 model.
